...
const FAQComponent = () => {
  ...
  const toggleBlock = (blockId) => {
    ...
    const Check = () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#3FA860" class="bi bi-check-circle" viewBox="0 0 16 16">
    ...
    const X = () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#EF4444" class="bi bi-x-circle" viewBox="0 0 16 16">
            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
      ...
      <div className='faqContainer'>
        <div className='faqBlock'>
          ...
          <div className={`blockContent ${openBlocks.block2 ? 'isOpen' : ''}`}>
            ...
            <div className='question'>
              <div className='questionText'>Как пригласить другого человека в парную сессию?</div>
